...
public class RowConverters {
    ...
    /**
     * Converts a POJO to RowData using reflection.
     *
     * @param pojo The POJO to convert
    ...
    /**
     * Infers a RowType from a POJO class and converts the POJO to RowData.
     *
    ...
    /**
     * Infers a RowType from a POJO class using reflection.
     *
     * @param pojoClass The class to analyze
     * @return The inferred RowType
     */
