...
/**
 * Utility class providing conversion methods between different row representations in the Fluss and
 * Flink ecosystems.
 *
 * <p>This class facilitates the transformation between:
 *
 * <ul>
 *   <li>POJOs and Fluss GenericRow
 *   <li>POJOs and Flink RowData
 *   <li>Various temporal and primitive data types to their Flink counterparts
 * </ul>
 *
 * <p>It offers reflection-based conversion mechanisms that preserve type information, with special
 * handling for common data types like strings, timestamps, dates, and numeric types.
 *
 * <p>This utility is primarily used for:
 *
 * <ul>
 *   <li>Testing data processing pipelines
 *   <li>Integration between Fluss storage systems and Flink runtime
 *   <li>Data format conversion during ETL operations
 * </ul>
 */
