...
class CompactedLogRecordTest extends LogTestBase {
    ...
    void testBase() throws IOException {
        ...
        // create a simple compacted row with 2 fields
        ...
        CompactedRow row =
                new CompactedRow(
                        fieldTypes.length,
                        new org.apache.fluss.row.compacted.CompactedRowDeserializer(fieldTypes));
        ...
        assertThat(logRecord.getSizeInBytes()).isGreaterThan(0);
