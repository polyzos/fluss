...
/** Tests for DefaultLogRecordBatch with COMPACTED log format. */
class DefaultLogRecordBatchCompactedTest extends LogTestBase {
    ...
    void testNoRecordAppend() throws Exception {
        ...
        try (LogRecordReadContext readContext =
                        LogRecordReadContext.createCompactedReadContext(baseRowType, schemaId);
                CloseableIterator<LogRecord> iter = logRecordBatch.records(readContext)) {
