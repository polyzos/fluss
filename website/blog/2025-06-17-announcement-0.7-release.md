...
> Note: Union Reads allows querying and combining the results from both historical and real-time data.
...
![Write Perf](assets/0.7/write_perf.png)
...
![Read Perfm](assets/0.7/read_perf.png)

Streaming partition pruning is the second pushdown feature introduced after streaming column pruning. 
...
Additionally, we've integrated Flink SQL's **'CALL' command** to ease ACL permission management for users. 
