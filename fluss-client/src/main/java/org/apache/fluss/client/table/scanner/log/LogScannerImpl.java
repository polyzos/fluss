 ...
 */
@PublicEvolving
public class LogScannerImpl implements LogScanner<org.apache.fluss.row.InternalRow> {
    ...
    @Override
    public ScanRecords<org.apache.fluss.row.InternalRow> poll(Duration timeout) {
        ...
        try {
            ...
            do {
                Map<TableBucket, List<org.apache.fluss.client.table.scanner.ScanRecord<org.apache.fluss.row.InternalRow>>> fetchRecords = pollForFetches();
    ...
    private Map<TableBucket, List<org.apache.fluss.client.table.scanner.ScanRecord<org.apache.fluss.row.InternalRow>>> pollForFetches() {
        Map<TableBucket, List<org.apache.fluss.client.table.scanner.ScanRecord<org.apache.fluss.row.InternalRow>>> fetchedRecords = logFetcher.collectFetch();
